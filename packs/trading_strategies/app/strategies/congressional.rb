...
module TradingStrategies
  module Strategies
    class Congressional < BaseStrategy
      ...
      def calculate_score(_ticker, ticker_trades)
...
# Provide a top-level Congressional constant for Zeitwerk while keeping the namespaced version.
class Congressional < TradingStrategies::Strategies::Congressional; end
